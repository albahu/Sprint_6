from data import get_kit_body, send_post_request
...
def test_allowed_characters_1():
    # Escenario 1: El número permitido de caracteres (1)
    kit_body = get_kit_body("a")

def test_allowed_characters_2():
